...
import edu.
colorado.phet.common.phetcommon.model.property.Not;
import edu.
colorado.phet.common.phetcommon.model.property.ObservableProperty;
import edu.
colorado.phet.common.phetcommon.model.property.Property;
import edu.
colorado.phet.common.phetcommon.util.function.Function2;
import edu.
...
import edu.
colorado.phet.common.piccolophet.event.CursorHandler;
import edu.
umd.cs.piccolo.event.PBasicInputEventHandler;
import edu.
...
import static edu.
colorado.phet.common.phetcommon.resources.PhetCommonResources.getMaximizeButtonImage;
import static edu.
...
ProtractorNode
{
  private
  double
  originalScale;//The scale when the protractor node is not expanded
  private
  Property < Boolean > expanded = new Property < Boolean > ( false );//True if the protractor has been made larger

  public
  ExpandableProtractorNode( final
  ModelViewTransform
  transform, final
  Property < Boolean > showProtractor, final
  ProtractorModel
  protractorModel, Function2 < Shape, Shape, Shape > translateShape, Function2 < Shape, Shape, Shape > rotateShape, double
  scale
)
  {
...
extends
  PImage
  {
    MaxMinButton( BufferedImage
    image, ObservableProperty < Boolean > expanded, final
    boolean
    expand
  )
    {
